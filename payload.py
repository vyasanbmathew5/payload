...
# Author - Vyasan B Mathew

# github - https://github.com/@vyasanbmathew5
...
"""+R+"""[ + ] """+G+""" Payload generator for Metasploit """+R+""" [ + ]"""+CY+"""
        ---"""+R+"""
        Code By ~ @vyasanbmathew5""")
        
    def main():
        print(CY+"""\n************************************************"""+CY+"""\n
"""+R+""" ~ [ + ] """+Y+"""Main menu"""+Y+"""

"""+R+"""["""+B+""" 1"""+R+""" ]"""+CY+""" Create a payload """+CY+"""
"""+R+"""["""+B+""" 2"""+R+""" ] """+CY+"""Start listner
"""+R+"""["""+B+""" 3"""+R+""" ] """+CY+"""Launch Metasploit
"""+R+"""["""+B+""" 4"""+R+""" ] """+CY+"""Exit\n""")
...
+Y+"\nmsfconsole not found ! Please install Meatsploit-Framework properly and try again :( \n"+W)
                ...
                if p=="y":
                    ...
                    print(Y+"\nExit......... ")
                    print(R+"\n "+CY+" Code by "+R+"["+CY+"~"+R+"]"+G+" @vyasanbmathew5"+R+"     "+W)
                    exit(0)                
                else:
    ...
    def sel():
        try:
            ...
            if c==1:
                ...
                print(R+" "+CY+" Git Hub "+R+"["+CY+"~"+R+"] "+G+" https://github.com/vyasanbmathew5"+R+"  \n"+W)
            else:
                check()
                print(R+"\nInvalid choice ! Please try again :(\n")
                main()                
...
"\n\n>>> "+R+"Interrupted!"+Y+" Exiting.........\n"+W)
    print(R+"\n-"+CY+" Code by "+R+"["+CY+"~"+R+"] "+CY+" @vyasanbmathew5"+W)
    print(CY+" Git Hub    "+R+"["+CY+"~"+R+"] "+G+" https://github.com/vyasanbmathew5"+R+"\n"+W)
